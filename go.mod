module github.com/khulnasoft-lab/fastnode
...
require (
	...
	github.com/khulnasoft-lab/fastnode/fastnode-go/client/datadeps v0.0.0-00010101000000-000000000000
...
replace github.com/fsnotify/fsevents => github.com/khulnasoft-lab/fsevents v0.0.0

replace github.com/sirupsen/logrus => github.com/Sirupsen/logrus v1.7.0

replace github.com/Sirupsen/logrus => github.com/sirupsen/logrus v1.7.0

replace github.com/khulnasoft-lab/fastnode/osx => ./osx

replace github.com/khulnasoft-lab/fastnode/linux => ./linux

replace github.com/khulnasoft-lab/fastnode/windows => ./windows

replace github.com/khulnasoft-lab/fastnode/fastnode-go/client/datadeps => ./fastnode-go/client/datadeps

replace github.com/rapid7/go-get-proxied => github.com/khulnasoft-lab/go-get-proxied v0.0.0
